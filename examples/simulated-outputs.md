...
本文件中的论文标题、作者、年份/来源和链接已通过公开可靠页面做过元信息核验；但这些示例没有声称逐段精读论文内容，也不代表实时文献综述。
...
信息依据：  
基于官方会议页面和可访问公开论文页面；本示例未声称逐段精读论文内容。
...
信息依据：  
基于官方会议页面和公开摘要/元信息；本示例未声称逐段精读论文内容，实验细节只做入门级概括。
...
信息依据：  
基于 OpenReview 官方页面和公开摘要/元信息；本示例未声称逐段精读论文内容。
...
- 如果输出者没有实际逐段精读论文内容，就不应展开具体实验细节、表格编号或精确结果。
